...
<Grid className={classes.rightDiv} md={6} item >
                        <img style={{ boxShadow: "10px 10px 20px grey ",width:"100%",height:"100%" }} src={`http://netdemo.site/infilate/public/images/${section2.media } `} alt="image"/>
...
<Grid className={classes.rightDiv} md={6} item >
    <img style={{boxShadow:"10px 10px 20px grey "}} src={`http://netdemo.site/infilate/public/images/${section3.media } `} alt="image"/>
...
<Grid className={classes.rightDiv} md={6} item >
  <img style={{boxShadow:"10px 10px 20px grey "}} src={`http://netdemo.site/infilate/public/images/${section4.media } `} alt="image"/>
...
<Grid  backgroundColor="white" container>
<Grid className={classes.rightDiv}  md={6} item >
   <img style={{boxShadow:"10px 10px 20px grey "}} src={`http://netdemo.site/infilate/public/images/${section5.media } `} alt="image" />
