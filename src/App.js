...
import FindProductAndServives from "./TestFunctionality/FindProductAndServives";
/*
  ...
  return (
    ...
    <Router>
      <Switch>
        ...
        <Route path="/webinar"> <ContactUsForm /> </Route>
        <Route path="/checkout"> <CheckOut /></Route>
        <Route path="/Brand"> <Brand /></Route>
        <Route path="/MainBlog"> <MainBlog /></Route>
        <Route path="/test"> <FindProductAndServives /></Route>
        
          
        <Route path="/Static"> <Static /> </Route> 
        <Route path="/RegisterCorporate"><RegisterCorporate/></Route>
        <Route path="/RegisterUser">  <RegisterUser /></Route>
        <Route path="/Login">  <Login/></Route>
